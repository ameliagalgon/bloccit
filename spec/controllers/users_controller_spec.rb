...
RSpec.describe UsersController, type: :controller do
     ...
     describe "GET confirm" do
          ...
          it "sets user name properly" do
               get :confirm, params: {name: new_user_attributes[:name], email: new_user_attributes[:email], password: new_user_attributes[:password], password_confirmation: new_user_attributes[:password_confirmation]}
               expect(assigns(:user).name).to eq new_user_attributes[:name]
          end
